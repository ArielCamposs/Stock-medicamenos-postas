            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid gap-3 text-sm sm:grid-cols-4">
                ...
                <div className={resumen.diferencias > 0
                  ...
                  <p className={`text-2xl font-bold tabular-nums mt-1 ${resumen.diferencias > 0
                ...
                <div className={resumen.bajoCritico > 0
                  ...
                  <p className={`text-2xl font-bold tabular-nums mt-1 ${resumen.bajoCritico > 0
                    ...
                    <tbody>
                      {filas.map((f) => {
                        ...
                        return (
                          <tr
                            key={f.id}
                            className={`border-b border-border/70 transition-colors ${bajoCritico
                          ...
                          >
                            <td className={`px-2 py-2.5 border-l-4 ${bajoCritico
                                ? "border-l-rose-500"
                                : tieneDiferencia
                                  ? "border-l-amber-500"
                            ...
                            <td className={`px-2 py-2.5 text-right font-semibold tabular-nums ${bajoCritico ? "text-rose-600 dark:text-rose-400" : ""
                              }`}>
                              {f.disponible}
                            </td>
                            <td className="px-2 py-2.5 text-right tabular-nums">{f.stockAvis}</td>
                            <td className={`px-2 py-2.5 text-right font-semibold tabular-nums ${f.diferenciaAvis > 0
                                ? "text-emerald-700 dark:text-emerald-400"
                                : f.diferenciaAvis < 0
                                  ? "text-amber-600 dark:text-amber-400"
